    ...
    <div className="registration-page">
      ...
      <main className="registration-layout">
        ...
        <div className="registration-intro">
          ...
          <p>
            Sport develops discipline, confidence and opportunity.
            Join the Zimsport4ED talent network and take the next
            step in your sporting journey.
          </p>
        ...
        >
          ...
          <div className="registration-header">
            ...
            <p>
              Tell us about yourself, your sport and your
              sporting journey.
            </p>
          ...
          >
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  id="club"
                  name="club"
                  placeholder="School, club or team (if applicable)"
                />
              </div>
            ...
            <div className="registration-consent">
              ...
              <label htmlFor="registrationConsent">
                ...
                and I consent to Zimsport4ED using it for registration
            ...
            {registrationStatus === 'success' && (
              ...
              <div className="registration-success">
                ...
                <h3>
                  Welcome to Zimsport4ED!
                </h3>

                <p>
                  Your athlete registration has been successfully
                  submitted. Thank you for taking the next step in
                  your sporting journey. Our team will review your
                  information and contact you when necessary.
                </p>
